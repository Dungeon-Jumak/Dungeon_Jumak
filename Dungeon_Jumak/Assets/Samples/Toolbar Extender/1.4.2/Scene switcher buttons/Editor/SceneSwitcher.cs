...
namespace UnityToolbarExtender.Examples
{
    ...
    public class SceneSwitchLeftButton
    {
        ...
        static void OnToolbarGUI()
        {
            ...
            {
                SceneHelper.OpenScene("StartScene");
            }

            if (GUILayout.Button(new GUIContent("Wait", "Waiting Scene")))
            {
                SceneHelper.OpenScene("WaitingScene");
            }

            if (GUILayout.Button(new GUIContent("House", "House Scene")))
            {
                SceneHelper.OpenScene("House");
            }
            ...
            if (GUILayout.Button(new GUIContent("Map", "Map Scene")))
            {
    ...
    static class SceneHelper
    {
        ...
        public static void OpenScene(string name, int SceneCheck)
        {
            ...
            {
                _ = EditorSceneManager.OpenScene($"Assets/Scenes/Dunjeon/{name}.unity");
            }
